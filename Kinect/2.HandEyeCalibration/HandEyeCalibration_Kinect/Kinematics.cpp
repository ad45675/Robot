...
Mat Kinematics::Forwardt(double theta1, double theta2, double theta3, double theta4, double theta5, double theta6)
{
	Mat T1,T2,T3,T4,T5,T6;
	calculateT(theta1,alpha1,a1,d1,&T1);
	calculateT(theta2,alpha2,a2,d2,&T2);
...
Mat Kinematics::ForwardJ7(double theta1, double theta2)
{
	Mat T1,T2;
	calculateT(theta1,alpha1,a1,d1,&T1);
	calculateT(theta2,alpha2,a7,d2,&T2);
	Mat output = Mat::zeros(4,4,CV_64FC1);
	output = T1*T2;
	return output;
}
Mat Kinematics::ForwardJ8(double theta1, double theta2, double theta3, double theta4)
{
	Mat T1,T2,T3,T4;
	calculateT(theta1,alpha1,a1,d1,&T1);
	calculateT(theta2,alpha2,a2,d2,&T2);
	calculateT(theta3,alpha3,a3,d3,&T3);
	calculateT(theta4,alpha4,a4,d8,&T4);
	Mat output = Mat::zeros(4,4,CV_64FC1);
	output = T1*T2*T3*T4;
	return output;
}
Mat Kinematics::ForwardJ9(double theta1, double theta2, double theta3, double theta4, double theta5, double theta6)
{
	Mat T1,T2,T3,T4,T5,T6;
	calculateT(theta1,alpha1,a1,d1,&T1);
	calculateT(theta2,alpha2,a2,d2,&T2);
	...
	calculateT(theta4,alpha4,a4,d4,&T4);
	calculateT(theta5,alpha5,a5,d5,&T5);
	calculateT(theta6,alpha6,a6,d9,&T6);
	Mat output = Mat::zeros(4,4,CV_64FC1);
	output = T1*T2*T3*T4*T5*T6;
	return output;
}
