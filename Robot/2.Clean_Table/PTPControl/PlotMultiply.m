    ...
    case 2
        ...
        for i = 1 : 6
            h3i = plotNy( MeasuredData.Time( : ), MeasuredData.Pos( : , i ),1,...
                ...
                MeasuredData.Time( : ), MeasuredData.TimerFlag( : ), 4,...
                'Linewidth',1,...
                'YAxisLabels',{'Pos[rad]' 'PosCmd[rad]' 'Vel[rad/s]' 'TimerFlag' },...
                'XAxisLabel','Time [s]',...
                ...
                'Grid','on',...
                'LegendString',{'Pos[rad]' 'PosCmd[rad]' 'Vel[rad/s]' 'TimerFlag'});
